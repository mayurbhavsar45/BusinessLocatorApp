...
namespace BusinessLocator.iOS
{
    ...
    partial class UserProfileViewController
    {
        ...
        [Outlet]
        [GeneratedCode ("iOS Designer", "1.0")]
        UIKit.UIView addressLabelView { get; set; }
        ...
        [Outlet]
        [GeneratedCode ("iOS Designer", "1.0")]
        UIKit.UIView emailLableView { get; set; }
        ...
        [Outlet]
        [GeneratedCode ("iOS Designer", "1.0")]
        UIKit.UIView ProfileHeaderView { get; set; }
        ...
        [Outlet]
        [GeneratedCode ("iOS Designer", "1.0")]
        UIKit.UIImageView ProfileWall { get; set; }

        [Outlet]
        [GeneratedCode ("iOS Designer", "1.0")]
        UIKit.UIView UserProfileView { get; set; }
